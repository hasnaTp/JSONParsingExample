...
public class CustomRepo2Adapter extends RecyclerView.Adapter<CustomRepo2Adapter.MyViewHolder> {

    private Context mContext;
    List<Repository> repoList = new ArrayList<Repository>();

    public CustomRepo2Adapter(Context mContext, List<Repository> repoList) {
